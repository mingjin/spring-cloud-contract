...
//			System.out.println("key:" + key);
			String str = prestr.append(key).toString();
			String sign = Md5Encrypt.md5(str);
			return sign;//把拼接后的字符串再与安全校验码直接连接起来,并且生成加密串
		}
		return null;
	}
...
//		String transport = configsDto.getTransport();
//
//		String merchant_ID = configsDto.getMerchantId();
//
...
//		} else{
//			veryfy_url.append(configsDto.getVerifyUrl());
//		}
