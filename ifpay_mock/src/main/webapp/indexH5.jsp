...
<div class="w">
	  <header id="top" class="headerred">
	    ...
	    <form name=rongpayment onSubmit="return CheckForm();" action=scantopay.jsp method=post target="_blank">
	   	 	<p class="t">
	        </p>
	        <p class="t">
	        </p>
	        ...
	        <p class="t">
	            <label for="cardNo">手机号</label>
	            <input type="tef" class="input" style = "margin-left: 0px;" name="phone" id="phone" />
